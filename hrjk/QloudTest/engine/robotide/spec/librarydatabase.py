...
DATABASE_FILE = os.path.join(decode_from_system(SETTINGS_DIRECTORY), 'librarykeywords.db')#数据库文件
...
def initialize_database():#数据库初始化
...
class LibraryDatabase(object):#数据库的库
    ...
    def insert_library_keywords(self, library_name, library_arguments, keywords):#插入库关键字
        cur = self._cursor()
    ...
    def update_library_timestamp(self, name, arguments, milliseconds=None):#更新库时间戳
