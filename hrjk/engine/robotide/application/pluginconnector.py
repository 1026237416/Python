...
def PluginFactory(application, plugin_class):#平台工厂
    try:
...
class _PluginConnector(object):#平台链接
...
class PluginConnector(_PluginConnector):#平台链接
...
class BrokenPlugin(_PluginConnector):#平台断开链接
