...
def LocalNamespace(controller, namespace, row=None):#本地命名空间
...
class LocalRowNamespace(LocalMacroNamespace):#本地行命名空间
    ...
    def _harvest_local_variables(self, start, suggestions):#收获本地变量
    ...
    def _could_be_variable(self, start):#是否是变量
    ...
    def _remove_duplicates(self, suggestions, local_variables):#移除副本
