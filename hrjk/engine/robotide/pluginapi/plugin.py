...
class Plugin(object):#插件
    ...
    def _delay_saving(self, delay):#推迟保存
        if not delay:
            return
        delay = delay * 1000
    ...
    def _save_setting_after_delay(self):#延期后保存设置
    ...
    def config_panel(self, parent):#面板配置
    ...
    def register_action(self, action_info):#注册功能
    ...
    def register_shortcut(self, shortcut, callback):#注册快捷键
        '''
    ...
    def register_search_action(self, description, handler, icon, default=False):#查找行动注册
