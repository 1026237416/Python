...
class SpecInitializer(object):#细则初始化
    ...
    def _find_from_library_xml_directories(self, name):#从xml库目录中寻找
    ...
    def _get_newest_xml_file(self, xml_file, current_xml_file):#返回最新的xml文件
...
def _parse_xml(file, name):#解析xml
...
def get_name_from_xml(path):#从xml中获取名字
    try:
